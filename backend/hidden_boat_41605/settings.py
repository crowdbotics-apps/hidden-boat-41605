"""
Django settings for hidden_boat_41605 project.
...
ROOT_URLCONF = 'hidden_boat_41605.urls'
...
WSGI_APPLICATION = 'hidden_boat_41605.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_boat_41605 API",
    "DESCRIPTION": "API documentation for hidden_boat_41605 App",
    "VERSION": "v1",
}
